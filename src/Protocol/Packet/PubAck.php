 ...
 *
 * The PUBACK packet is the response to a PUBLISH packet with QoS level 1 (At least once delivery).
 * It confirms receipt of the PUBLISH packet to the sender.
 *
 * QoS 1 Flow:
 * 1. Sender sends a PUBLISH packet with QoS 1 and Packet Identifier
 * 2. Receiver sends a PUBACK packet with matching Packet Identifier
 * 3. Sender considers the message delivered upon receiving PUBACK
 *
 ...
 * - Fixed Header: Type (4), flags (0), Remaining Length (2)
...
final class PubAck
{
     ...
     * @param  array<string, mixed>|null  $properties  MQTT 5.0 PUBACK properties. Possible keys:
    ...
    /**
     * Get a property value from MQTT 5.0 PUBACK properties.
     *
    ...
    /**
     * Check if a property exists in MQTT 5.0 PUBACK properties.
     */
